...
Contributions to `CTUNetwork` are welcome. If you have ideas, open an [issue](https://github.com/CTU-Bern/CTUNetwork/issues) or a [discussion thread](https://github.com/CTU-Bern/CTUNetwork/discussions) on GitHub. 
